import click
from pipelines.deployment_pipeline import continuous_deploymnet_pipeline,inference_pipeline
...
@click.option(
    ...
    is_flag=True,
    default=False,
    help= "Stop the predction servce when done"
)
...
def run_main(stop_service:bool):
    ...
    if stop_service:
        ...
        return
    continuous_deploymnet_pipeline()
