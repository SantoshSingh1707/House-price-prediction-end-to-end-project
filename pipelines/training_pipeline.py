...
def ml_pipeline():
    ...
    clean_data = outlier_detection_step(engineered_data,columns_name="SalePrice")

    X_train , X_test ,y_train , y_test = data_splitter_step(clean_data,target_columns="SalePrice")
